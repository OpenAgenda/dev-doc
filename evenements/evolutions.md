...
Contactez-nous par courriel pour toute remarque ou demande à <support@openagenda.com>.

## Vue d'ensemble[​](#vue-densemble "Lien direct vers Vue d'ensemble")
...
## Lecture[​](#lecture "Lien direct vers Lecture")
...
## Le champ `offers` — catalogue par billetterie[​](#le-champ-offers--catalogue-par-billetterie "Lien direct vers le-champ-offers--catalogue-par-billetterie")
...
### `tiers[]` — un tarif individuel[​](#tiers--un-tarif-individuel "Lien direct vers tiers--un-tarif-individuel")
...
### `pricing` — règles[​](#pricing--règles "Lien direct vers pricing--règles")
...
## `offersAggregate` — pour les listings[​](#offersaggregate--pour-les-listings "Lien direct vers offersaggregate--pour-les-listings")
...
### Règles de dérivation[​](#règles-de-dérivation "Lien direct vers Règles de dérivation")
...
## `timings[].id` — identité de plage horaire[​](#timingsid--identité-de-plage-horaire "Lien direct vers timingsid--identité-de-plage-horaire")
...
## Surcharge tarifaire par plage horaire — `timing.offers[]`[​](#surcharge-tarifaire-par-plage-horaire--timingoffers "Lien direct vers surcharge-tarifaire-par-plage-horaire--timingoffers")
...
### Règles[​](#règles "Lien direct vers Règles")
...
## `timings[].availability` — statuts des offres[​](#timingsavailability--statuts-des-offres "Lien direct vers timingsavailability--statuts-des-offres")
...
### Champs[​](#champs "Lien direct vers Champs")
...
### Statut — comment c'est dérivé[​](#statut--comment-cest-dérivé "Lien direct vers Statut — comment c'est dérivé")
...
### Compteur de fraîcheur[​](#compteur-de-fraîcheur "Lien direct vers Compteur de fraîcheur")
...
## Cohabitation avec `registration` et `conditions`[​](#cohabitation-avec-registration-et-conditions "Lien direct vers cohabitation-avec-registration-et-conditions")
...
## Écriture (API)[​](#écriture-api "Lien direct vers Écriture (API)")
...
## JSON-LD[​](#json-ld "Lien direct vers JSON-LD")
...
## Implémentation[​](#implémentation "Lien direct vers Implémentation")
...
## Annexes[​](#annexes "Lien direct vers Annexes")

### A. Exemple complet — événement multi-source multi-date[​](#a-exemple-complet--événement-multi-source-multi-date "Lien direct vers A. Exemple complet — événement multi-source multi-date")
...
### B. Exemple — événement gratuit[​](#b-exemple--événement-gratuit "Lien direct vers B. Exemple — événement gratuit")
...
### C. Exemple — événement avec participation libre[​](#c-exemple--événement-avec-participation-libre "Lien direct vers C. Exemple — événement avec participation libre")
