...
description: Update a location on an agenda using the standard method or with an external identifier
sidebar_position: 4
---
...
## Editing using an external identifier

```bash
PUT /v2/agendas/{agendaUID}/locations/ext/{key}/{value}
```

Documented [here](/lieux/creation#creation-using-an-external-identifier).
