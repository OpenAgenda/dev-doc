---
title: The /v2/agendas/${agendaUID}/locations routes
description: View and edit the locations of an agenda
slug: /lieux
---
...
* [Structure](/lieux/structure): details of the fields that make up a location.
* [Read](/lieux/lecture): Read location data from an agenda.
* [Create](/lieux/creation): Create a location on an agenda.
* [Edit](/lieux/edition): Fully or partially update a location on an agenda.
* [Delete](/lieux/suppression): Delete a location.
