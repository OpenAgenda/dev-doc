...
Une gestion plus fine des droits liés aux clés API (expiration, opérations et agendas autorisés) sera déployée dans le courant du mois de septembre 2026: voir [Droits des clés API](/evolutions/cles-api).
